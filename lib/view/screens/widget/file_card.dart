...
class Card_file extends StatefulWidget {
  int index = 0;
  int numberOfLines = 0;
  Card_file(this.index);
  @override
  _CardListState createState() => _CardListState(this.index);
}

class _CardListState extends State<Card_file> {
//class Card_file extends StatelessWidget {
  ...
  late List p = controller1.grouplist;
  int idgroup = 0;
            ...
            children: [
              Checkbox(
                  ...
                  value: controller.selectedIndices
                      .contains(controller.filemodel!.files[index].id),
                ...
                child: Column(
                    ...
                    children: [
                      TextUtils(
                          ...
                          text:
                              " this file is ${controller.filemodel!.files[index].status}",
                      ...
                      Text(
                        "${controller.filemodel!.files[index].name}",
                  ...
                  showMenu(
                    ...
                    if (value == "Delete") {
                      ...
                      await controller.DeleteFile(
                          controller.filemodel!.files[index].id);
                      ...
                      // Handle the selected value
                      controller
                          .downloadFile(controller.filemodel!.files[index].id);
                      // print(controller.filemodel!.files[index].id);
                      ...
                      // controller.downloadFile(
                      //     controller.path_download, controller.name_download);
                      ...
                      _showCardListDialog(
                          context, controller.filemodel!.files[index].id);
                    }
                    // }
                  });
                },
